...
public class Problem_user {
    ...
    public void testLoginAndSnapshot() throws Exception {
        ...
        // Send login credentials for "problem_user"
        methods.SendLoginCredentials("problem_user", "secret_sauce");

        // Take a snapshot before login
        methods.takeSnapShot(driver, ".\\Login_Problem_user.png");
    }
    ...
    public void testCheckoutProcess() {
        ...
        try {
            ...
            System.out.println("Test stopped: Problem user encountered an issue after clicking Continue.");
            driver.quit();
            Assert.fail("Encountered an issue during the checkout process.");
        }
    }
