...
public class Performance_Glitch_User {
    ...
    public void testLoginAndSnapshot() throws Exception {
        ...
        // Send login credentials for "performance_glitch_user"
        methods.SendLoginCredentials("performance_glitch_user", "secret_sauce");

        // Take a snapshot before login
        methods.takeSnapShot(driver, ".\\Login_Performance_Glitch_user.png");
    }
